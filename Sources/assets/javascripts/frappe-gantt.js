...
class Gantt {
    ...
    setup_gantt_dates() {
        ...
        if (this.view_is(['Quarter Day', 'Half Day','Week'])) { // modif, ajout de Week
            this.gantt_start = date_utils.add(this.gantt_start, 1, 'day'); // 0 à la place de -7
    ...
    get_date_info(date, last_date, i) {
        ...
        const x_pos = {
            ...
            Day_upper: this.options.column_width * 5 / 2,
            Week_lower: 0,
